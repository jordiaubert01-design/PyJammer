...
jammer.play_progression(p3b, repetitions=1, bass_line="half")
#riff
jammer.play_progression(p4, bass_line="half", repetitions=2, text="Riff")
#Solo
jammer.play_progression(p2, bass_line="half", repetitions=2, text="Solo")
jammer.play_progression(p3b, repetitions=1, bass_line="half")
jammer.play_progression(p4, repetitions=2, bass_line="half")
...
jammer.set_bpm(140)
jammer.play_progression(p4, pattern="standard", bass_line="half", repetitions=8)
